  ...
  return (
    <div className={`h-full w-full rounded-xl overflow-hidden shadow-inner border relative ${isDarkMode ? 'border-gray-700 bg-gray-900' : 'border-gray-200'}`}>
      ...
      {!userLocation && !selectingLocation && (
        <div className="absolute top-4 left-1/2 transform -translate-x-1/2 z-[1000] bg-gray-800/80 backdrop-blur-sm text-white px-4 py-2 rounded-full shadow-lg text-sm font-medium pointer-events-none flex items-center gap-2">
