...
export const LocationConfirmOverlay = React.memo(({
  isSelectingLocation,
  hasTempLocation,
  onCancel,
  onConfirm
}: LocationConfirmOverlayProps) => {
  if (!isSelectingLocation || !hasTempLocation) return null;
...
LocationConfirmOverlay.displayName = 'LocationConfirmOverlay';
