...
export const TaskList: React.FC<TaskListProps> = ({
  ...
  }, [tasks, userLocation?.lat, userLocation?.lng, toggleTask, setTaskToDelete, setEditingTask]);
  ...
  return (
    <div className="flex-1 overflow-y-auto overscroll-contain p-4 pb-4 max-w-2xl mx-auto w-full">
      ...
      {/* Task List */}
      <h2 className="text-lg font-bold text-gray-800 dark:text-white mb-3">Tareas pendientes ({pendingCount})</h2>
      {tasks.length === 0 ? (
