...
export const USER_ICON = L.divIcon({
  ...
  html: `<div style="width: 16px; height: 16px; background-color: #2563eb; border-radius: 50%; border: 3px solid white; box-shadow: 0 0 0 2px rgba(37, 99, 235, 0.4), 0 0 10px rgba(0,0,0,0.5); animation: pulse 2s infinite;"></div>`,
  iconSize: [16, 16],
  iconAnchor: [8, 8],
});
